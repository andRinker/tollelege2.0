...
type RosterActionsProps = {
  ...
  defaultSchoolYear: string;
  classes: ClassOption[];
  /** False for a co-teacher: renaming, archiving and deleting a class stay with its owner. */
        ...
        <MenuTrigger>
          ...
          <Menu
            ...
            onAction={async (key) => {
              ...
              if (key === "archive") {
                const result = await archiveClassAction(
                  klass.id,
                  !klass.archived,
                );
                showSnackbar({
          ...
          >
            ...
            <MenuItem
              id="archive"
              icon={klass.archived ? iconUnarchive : iconArchive}
            >
